...
// ── 4) RioCan / Walker — real aerial cover + site plan / landmark docs ──
const rio = find('riocan-walker-towne-centre');
if (rio) {
    rio.heroImage = '../public/RioCan_Centre_Aerial.jpg';
    rio.documents = [
        {
